  ...
  _autoevaluacion() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Image.asset('assets/images/mas.png',height: 50.0,width: 50.0,color: Colors.black,),
            Container(
              ...
              width: 200,
                ...
                children: <Widget>[
                 ...
                 Image.asset('assets/images/siguiente.png',height: 50.0,width: 50.0,color: Colors.black,),
          ],
        ),
      ),
    );
  ...
  _sintomas() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            Image.asset('assets/images/sintomas.png',height: 50.0,width: 50.0),
            Text('Síntomas',style: TextStyle(color:Colors.white),)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            Image.asset('assets/images/cuidados.png',height: 50.0,width: 50.0),
            Text('Cuidados en',style: TextStyle(color:Colors.white),),
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text('Cuidados al',style: TextStyle(color:Colors.white),),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Container(
              child: Image.asset('assets/images/camera.png',height: 50.0,width: 50.0,color: Colors.black,)),
            Container(
              width: 200,
                child: Column( 
                children: <Widget>[
  ...
  _preguntas() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Image.asset('assets/images/cel.png',height: 50.0,width: 50.0,color: Colors.black,),
            Container(
              width: 200,
                child: Column( 
                children: <Widget>[
